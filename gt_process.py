...
gd_f = gpd.read_file ('C:\\Users\\Clare\\Documents\\MscDiss\\GT\\RW_GT.shp')

# get names of land cover classes/labels
class_names = gd_f['lc'].unique()
class_names = np.sort(class_names)  # alphabetise class names to bog, forest, grass
...
gdf_train = gd_f.sample(frac=0.7)  # 70% training
gdf_test = gd_f.drop(gdf_train.index)
print('gd_f shape', gd_f.shape,'training shape', gdf_train.shape, 'test', gdf_test.shape)
gdf_train.to_file('C:\\Users\\Clare\\Documents\\MscDiss\\GT\\RW_gt_train.shp')
gdf_test.to_file('C:\\Users\\Clare\\Documents\\MscDiss\\GT\\RW_gt_test.shp')